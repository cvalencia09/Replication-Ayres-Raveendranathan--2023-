...
integer, allocatable, dimension(:,:,:,:) :: g_i_a_integer_t
double precision, dimension(neps,nk,na) :: omega_ss0, omega_ss1

double precision, parameter :: weight=.9975, weight_w=.975

double precision :: vals(2), vals_shock(2), vals_no_shock(2)
integer :: inds(2), inds_shock(2), inds_no_shock(2)

double precision, parameter :: tol_tr=.003
...
double precision, allocatable, dimension(:,:,:) :: omega_no_shock, omega_shock, omega_no_shock4, omega_shock4
integer(kind=1) :: d_o_no_shock, d_o_shock
integer :: jk_shock, jk_no_shock
double precision :: ap_shock, ap_no_shock

integer :: jeps3
double precision :: vals2(2)
integer :: inds2(2)


!5th quarter
double precision, allocatable, dimension(:,:,:) :: omega_no_shock5, omega_shock5

!2nd quarter of shock
integer :: d_o_no_shock_q2_1, d_o_no_shock_q2_2, d_o_shock_q2_1, d_o_shock_q2_2
double precision :: mass_dummy_q2_1, mass_dummy_q2_2
integer :: jk_no_shock_q2_1, jk_no_shock_q2_2, jk_shock_q2_1, jk_shock_q2_2
double precision :: ap_no_shock_q2_1, ap_no_shock_q2_2, ap_shock_q2_1, ap_shock_q2_2
double precision, dimension(2) :: vals_no_shock2_1, vals_shock2_1
integer, dimension(2) :: inds_no_shock2_1, inds_shock2_1
double precision, dimension(2) :: vals_no_shock2_2, vals_shock2_2
integer, dimension(2) :: inds_no_shock2_2, inds_shock2_2

!3rd quarter of shock
integer :: d_o_no_shock_q3_1, d_o_no_shock_q3_2, d_o_no_shock_q3_3, d_o_no_shock_q3_4
integer :: d_o_shock_q3_1, d_o_shock_q3_2, d_o_shock_q3_3, d_o_shock_q3_4
double precision :: mass_dummy_q3_1, mass_dummy_q3_2, mass_dummy_q3_3, mass_dummy_q3_4
integer :: jeps4
integer :: jk_no_shock_q3_1, jk_no_shock_q3_2, jk_no_shock_q3_3, jk_no_shock_q3_4
integer :: jk_shock_q3_1, jk_shock_q3_2, jk_shock_q3_3, jk_shock_q3_4
double precision :: ap_no_shock_q3_1, ap_no_shock_q3_2, ap_no_shock_q3_3, ap_no_shock_q3_4
double precision :: ap_shock_q3_1, ap_shock_q3_2, ap_shock_q3_3, ap_shock_q3_4
double precision, dimension(2) :: vals_no_shock3_1, vals_shock3_1
double precision, dimension(2) :: vals_no_shock3_2, vals_shock3_2
double precision, dimension(2) :: vals_no_shock3_3, vals_shock3_3
double precision, dimension(2) :: vals_no_shock3_4, vals_shock3_4
integer, dimension(2) :: inds_no_shock3_1, inds_shock3_1
integer, dimension(2) :: inds_no_shock3_2, inds_shock3_2
integer, dimension(2) :: inds_no_shock3_3, inds_shock3_3
integer, dimension(2) :: inds_no_shock3_4, inds_shock3_4

!4th quarter of shock
integer :: d_o_no_shock_q4_1, d_o_no_shock_q4_2, d_o_no_shock_q4_3, d_o_no_shock_q4_4
integer :: d_o_no_shock_q4_5, d_o_no_shock_q4_6, d_o_no_shock_q4_7, d_o_no_shock_q4_8
integer :: d_o_shock_q4_1, d_o_shock_q4_2, d_o_shock_q4_3, d_o_shock_q4_4
integer :: d_o_shock_q4_5, d_o_shock_q4_6, d_o_shock_q4_7, d_o_shock_q4_8

double precision :: mass_dummy_q2_3, mass_dummy_q2_4
    ...
    if ( rank .eq. 0 ) then
        ...
        g_un_o_t(t1,neps,nk),g_binding_collateral_t(t1,neps,nk,na),g_i_a_integer_t(t1,neps,nk,na))
    ...
    g_i_a_integer_t(1,:,:,:)=g_i_a_integer_initial
    ...
    g_i_a_integer_t(t1,:,:,:)=g_i_a_integer_final
...
iter_tr=0
    ...
    do while ( iter_tr .le. itmax_tr .and. d_tr .ge. tol_tr )
        ...
        if ( GHH .eq. 0 .and. habit .eq. 0 ) then
                ...
                w_t(t)=(wmin+wmax)/2
                    ...
                    jk_temp=-1
                        ...
                        kp=grid_k(jk)
                            ...
                            +(1.+tau_x_t(t))*((1-delta_k)*k-kp)-func_adj(kp,k,d_o,t)-f_o_good

                            ev=e_v_un_recmpi(zmap_inv_un(ieps,jk)) 
                            vtemp0=profit+(1-delta_f)*ev/(1+r_t(t+1))       !beta*psi_c_t(t+1)*c_t(t)/(psi_c_t(t)*c_t(t+1))
                        ...
                        ev=e_v_un_recmpi(zmap_inv_un(ieps,jk)) 
                        vtemp=profit+(1-delta_f)*ev/(1+r_t(t+1))   !beta*psi_c_t(t+1)*c_t(t)/(psi_c_t(t)*c_t(t+1))
                    ...
                    kp=grid_k(jk)
                        ...
                        ap=ap_entry_un(ieps)
                            ...
                            print*,'ap .lt. zero for unconstrained entrant choice, transition.f90'
                                call exit

                            end if
                                        
                        profit=((Z_t(t)*eps)**(1-alpha*nu))*(((k**alpha)*(l**(1-alpha)))**nu)-w_t(t)*(l+f_o_t(t)*grid_z(iz))&
                        +(1.+tau_x_t(t))*((1-delta_k)*k-kp)+a-q*ap-func_adj(kp,k,d_o,t)-f_o_good
...
!                             if ( profit .ge. zero .or. profit .lt. zero ) then
                            ...
                            v_entry(ieps)=profit+(1-delta_f)*ev/(1+r_t(t+1))   !beta*psi_c_t(t+1)*c_t(t)/(psi_c_t(t)*c_t(t+1))
                            ...
                            kpmax=kmax
                                ...
                                a+(1.+tau_x_t(t))*((1-delta_k)*k-kp)-func_adj(kp,k,d_o,t)-f_o_good
...
!                    call exit
            ...
            jk_temp=-1
                ...
                ev=e_v_un_recmpi(zmap_inv_un(ieps,jk))  
                vtemp=profit+(1-delta_f)*ev/(1+r_t(t+1))        !*psi_c_t(t+1)*c_t(t)/(psi_c_t(t)*c_t(t+1))
            ...
            allocate (g_i_o_mpi(np),g_i_k_mpi(np),g_i_a_mpi(np),v_i_mpi(np),g_i_a_integer_mpi(np))
            ...
            kp=grid_k(jk)
                ...
                ap=a_un_t(t,ieps,ik)
                    ...
                    print*,'ap .lt. zero, unconstrained incumbent, transition.f90'
                        call exit                                        
                    end if       
...
!                     if ( profit .ge. zero .or. profit .lt. zero ) then
            ...
            deallocate (g_i_o_mpi,g_i_k_mpi,g_i_a_mpi,v_i_mpi,g_i_a_integer_mpi)
...
!                     end if
                ...
                g_i_a_integer_t(t,ieps,ik,ia)=g_i_a_integer_recmpi(cnt)
...
!                     end if
    ...
    deallocate (g_i_o_recmpi,g_i_k_recmpi,g_i_a_recmpi,v_i_recmpi,e_v_i_recmpi,g_i_a_integer_recmpi)
    ...
    !         h_t(t)=1-psi_t(t)*c_t(t)/w_t(t)
                ...
                if ( ex_entry .eq. 0 ) then
                    ...
                    h_t(t)=(w_t(t)*(1-tau_l_t(t))/psi_t(t))**(one/phi)
                    end if
                        ...
                        kp=grid_k(jk)
                            ...
                            l=(w_t(t)/(((Z_t(t)*eps)**(1-alpha*nu))*(1-alpha)*nu*(k**(alpha*nu))))**(one/((1-alpha)*nu-1))
                                ...
                                q=one/(one+r_t(min(t+1,t1-1)))
                                    ...
                                    ja=g_i_a_integer_t(t,ieps,ik,ia)
                                    
                                        if ( ja .le. 0 ) then
                                        print*,'ja .le. 0, transition.f90'
                                            call exit
                                        end if
                                        
                                    q=g_q_t(t,ieps,jk,ja)
                                    end if
                            ...
                            gdp_t(t)=gdp_t(t)+(((Z_t(t)*eps)**(1-alpha*nu))*(((k**alpha)*(l**(1-alpha)))**nu)-f_o_good)*&
                            (omega_ss0(ieps,ik,ia)+mu_t(t)*put_eps_t(t,ieps)*g_e_o_t(t,ieps))
                            ngdp_t(t)=ngdp_t(t)+(((Z_t(t)*eps)**(1-alpha*nu))*(((k**alpha)*(l**(1-alpha)))**nu)-f_o_good)*&
                            (omega_ss0(ieps,ik,ia)+mu_t(t)*put_eps_t(t,ieps)*g_e_o_t(t,ieps))           
                            ...
                            (omega_ss0(ieps,ik,ia)+mu_t(t)*put_eps(ieps)*g_e_o_t(t,ieps))
                                ...
                                if ( ap .lt. zero ) then
                                avg_spread_t(t)=avg_spread_t(t)+(one/q-1-r_t(t+1))*(omega_ss0(ieps,ik,ia)+mu_t(t)*put_eps_t(t,ieps)*g_e_o_t(t,ieps))
                                debtors_t(t)=debtors_t(t)+(omega_ss0(ieps,ik,ia)+mu_t(t)*put_eps_t(t,ieps)*g_e_o_t(t,ieps))
                                end if
                            ...
                            omega_ss0(ieps,ik,ia)
                                ...
                                if ( ap .lt. zero ) then
                                avg_spread_t(t)=avg_spread_t(t)+(one/q-1-r_t(t+1))*omega_ss0(ieps,ik,ia)
                                debtors_t(t)=debtors_t(t)+omega_ss0(ieps,ik,ia)
                                end if
            ...
            avg_spread_t(t)=avg_spread_t(t)/debtors_t(t)
            ...
            do t=2,t1-1
                ...
                w_t1(t)=w_t(t)
                    ...
                    w_t1(t)=(psi_t(t)*(h_t(t)**phi))/(1-tau_l_t(t))
                    end if
            ...
            do t=3,t1-1        
                ...
                if ( habit .eq. 0 ) then
                    ...
                    r_t1(t)=(c_t(t)-psi_t(t)*(h_t(t)**(1+phi))/(1+phi))/(beta*(c_t(t-1)-psi_t(t-1)*(h_t(t-1)**(1+phi))/(1+phi)))-one
                    end if
                
                else if ( habit .eq. 1 ) then
                r_t1(t)=(c_t(t)-psi_t(t)*(h_t(t)**(1+phi))/(1+phi)-lambda_c*(c_t(t-1)-psi_t(t-1)*(h_t(t-1)**(1+phi))/(1+phi)))/&
                (beta*(c_t(t-1)-psi_t(t-1)*(h_t(t-1)**(1+phi))/(1+phi)-lambda_c*(c_t(t-2)-psi_t(t-2)*(h_t(t-2)**(1+phi))/(1+phi))))-one                                
                end if
...
!             w_t=.7*w_t+(1-.7)*w_t1
            ...
            write(1,*)'spread'
                ...
                exdem_t(t),psi_c_t(t),collateral_binding_t(t),avg_spread_t(t)
                end do
            close(1)
...
!     allocate (omega_no_shock(neps,nk,na), omega_shock(neps,nk,na),omega_no_shock4(neps,nk,na),omega_shock4(neps,nk,na),&
!     omega_no_shock5(neps,nk,na),omega_shock5(neps,nk,na))            
!             
...
!                         end if
!                                             
!                     output_loss_entry_t(tc)=output_loss_entry_t(tc)+(((Z_t(1)*eps)**(1-alpha*nu))*(((k**alpha)*(l**(1-alpha)))**nu)-&
!                     f_o_good)*omega_ss0(ieps,ik,ia)
...
!                         end if
!                                             
!                     output_gain_entry_t(tc)=output_gain_entry_t(tc)+(((Z_t(tc)*eps)**(1-alpha*nu))*(((k**alpha)*(l**(1-alpha)))**nu)-&
!                     f_o_good)*omega_ss0(ieps,ik,ia)
...
!         end if
!         
!     omega_no_shock4=zero    !t=4    !firms that survived t=2 and t=3
!     omega_shock4=zero   !t=4    !firms that survived t=2 and t=3
!     
!     omega_no_shock5=zero    !t=5    !firms that survived t=2 and t=3
!     omega_shock5=zero   !t=5    !firms that survived t=2 and t=3
!             
!         do t=2,min(222,t1-1)
! 
...
!             
!                 if ( t .eq. 4 ) then
!                 omega_no_shock=omega_no_shock4
!                 omega_shock=omega_shock4            
!                 else if ( t .eq. 5 ) then
!                 omega_no_shock=omega_no_shock5
!                 omega_shock=omega_shock5
!                 end if
!                         
!             !add period 3/4 entrants given their choices
!             omega_ss0=zero
! 
!                 do ieps=1,neps
!                 
!                     if ( g_e_o_t(t-1,ieps) .eq. 1 .and. g_e_o_t(1,ieps) .eq. 1 ) then !enter in t and would have entered in t=1                                
!                     omega_ss0(ieps,intbirth_k,intbirth)=omega_ss0(ieps,intbirth_k,intbirth)+min(mu_t(1)*put_eps_t(1,ieps),mu_t(t-1)*put_eps_t(t-1,ieps))                
!                     end if
!                 
!                 end do
!             
!                 do ieps=1,neps
!                 do ik=intbirth_k,intbirth_k
!                 do ia=intbirth,intbirth
! 
!                     if ( omega_ss0(ieps,ik,ia) .gt. zero ) then
!                 
!                     d_o=g_i_o_t(1,ieps,ik,ia)
...
!                     ap=g_i_a_t(1,ieps,ik,ia)
!                 
!                     d_o_shock=g_i_o_t(t-1,ieps,ik,ia)
!                     jk_shock=g_i_k_t(t-1,ieps,ik,ia)
!                     ap_shock=g_i_a_t(t-1,ieps,ik,ia)                
!     
!                         !next period distribution                                    
!                         if ( d_o .eq. 1 ) then
! 
!                             call basefun (grid_a(1,:),na,ap,vals,inds)                                                        
!                             call basefun (grid_a(t,:),na,ap_shock,vals_shock,inds_shock)                         
!                         
!                             do jeps=1,neps
!                             
!                                 if ( pi_eps(ieps,jeps) .gt. zero ) then                                                
!                          
!                                 d_o_no_shock_q2_1=g_i_o_t(1,jeps,jk,inds(1))                            
!                                 d_o_no_shock_q2_2=g_i_o_t(1,jeps,jk,inds(2))
!                                 
!                                 d_o_shock_q2_1=g_i_o_t(t,jeps,jk_shock,inds_shock(1))
!                                 d_o_shock_q2_2=g_i_o_t(t,jeps,jk_shock,inds_shock(2))
!                         
!                                     if ( ( d_o_no_shock_q2_1 .eq. 1 .and. d_o_shock_q2_1 .eq. 1 ) .and. &
!                                     ( d_o_no_shock_q2_1 .eq. 1 .and. d_o_shock_q2_2 .eq. 1 ) .and. &
!                                     ( d_o_no_shock_q2_2 .eq. 1 .and. d_o_shock_q2_1 .eq. 1 ) .and. &
!                                     ( d_o_no_shock_q2_2 .eq. 1 .and. d_o_shock_q2_2 .eq. 1 ) ) then
!                                 
!                                     omega_no_shock(jeps,jk,inds(1))=omega_no_shock(jeps,jk,inds(1))+vals(1)*pi_eps(ieps,jeps)*omega_ss0(ieps,ik,ia)                                                                                                                
!                                     omega_no_shock(jeps,jk,inds(2))=omega_no_shock(jeps,jk,inds(2))+vals(2)*pi_eps(ieps,jeps)*omega_ss0(ieps,ik,ia)                                                                                         
! 
!                                     omega_shock(jeps,jk_shock,inds_shock(1))=omega_shock(jeps,jk_shock,inds_shock(1))+&
!                                     vals_shock(1)*pi_eps(ieps,jeps)*omega_ss0(ieps,ik,ia)                                                                                                            
!                                     omega_shock(jeps,jk_shock,inds_shock(2))=omega_shock(jeps,jk_shock,inds_shock(2))+&
!                                     vals_shock(2)*pi_eps(ieps,jeps)*omega_ss0(ieps,ik,ia) 
!                       
!                                         if ( t .eq. 4 ) then                                                            
!                                                             
!                                         mass_dummy_q2_1=vals(1)*pi_eps(ieps,jeps)*omega_ss0(ieps,ik,ia)
!                                         mass_dummy_q2_2=vals(2)*pi_eps(ieps,jeps)*omega_ss0(ieps,ik,ia)
!                                         mass_dummy_q2_3=vals_shock(1)*pi_eps(ieps,jeps)*omega_ss0(ieps,ik,ia)
!                                         mass_dummy_q2_4=vals_shock(2)*pi_eps(ieps,jeps)*omega_ss0(ieps,ik,ia)
!                                     
!                                         jk_no_shock_q2_1=g_i_k_t(1,jeps,jk,inds(1))
!                                         jk_no_shock_q2_2=g_i_k_t(1,jeps,jk,inds(2))
!                                     
!                                         ap_no_shock_q2_1=g_i_a_t(1,jeps,jk,inds(1))
!                                         ap_no_shock_q2_2=g_i_a_t(1,jeps,jk,inds(2))
!     
!                                         jk_shock_q2_1=g_i_k_t(t,jeps,jk_shock,inds_shock(1))
!                                         jk_shock_q2_2=g_i_k_t(t,jeps,jk_shock,inds_shock(2))
! 
!                                         ap_shock_q2_1=g_i_a_t(t,jeps,jk_shock,inds_shock(1))                                                    
!                                         ap_shock_q2_2=g_i_a_t(t,jeps,jk_shock,inds_shock(2))                
!                                     
!                                             call basefun (grid_a(1,:),na,ap_no_shock_q2_1,vals_no_shock2_1,inds_no_shock2_1)                                                                                                                     
!                                             call basefun (grid_a(1,:),na,ap_no_shock_q2_2,vals_no_shock2_2,inds_no_shock2_2)                                                                                                                     
! 
!                                             call basefun (grid_a(t+1,:),na,ap_shock_q2_1,vals_shock2_1,inds_shock2_1) 
!                                             call basefun (grid_a(t+1,:),na,ap_shock_q2_2,vals_shock2_2,inds_shock2_2) 
! 
!                                             do jeps3=1,neps
!                                             
!                                                 if ( pi_eps(jeps,jeps3) .gt. zero ) then                    
!                                             
!                                                 d_o_no_shock_q3_1=g_i_o_t(1,jeps3,jk_no_shock_q2_1,inds_no_shock2_1(1))                            
!                                                 d_o_no_shock_q3_2=g_i_o_t(1,jeps3,jk_no_shock_q2_1,inds_no_shock2_1(2))                            
!                                                 d_o_no_shock_q3_3=g_i_o_t(1,jeps3,jk_no_shock_q2_2,inds_no_shock2_2(1))                            
!                                                 d_o_no_shock_q3_4=g_i_o_t(1,jeps3,jk_no_shock_q2_2,inds_no_shock2_2(2))                            
!                                 
!                                                 d_o_shock_q3_1=g_i_o_t(t+1,jeps3,jk_shock_q2_1,inds_shock2_1(1))
!                                                 d_o_shock_q3_2=g_i_o_t(t+1,jeps3,jk_shock_q2_1,inds_shock2_1(2))                                                                            
!                                                 d_o_shock_q3_3=g_i_o_t(t+1,jeps3,jk_shock_q2_2,inds_shock2_2(1))
!                                                 d_o_shock_q3_4=g_i_o_t(t+1,jeps3,jk_shock_q2_2,inds_shock2_2(2))                                                                                        
! 
!                                                     if ( &
!                                                     ( d_o_no_shock_q3_1 .eq. 1 .and. d_o_shock_q3_1 .eq. 1 ) .and. &                            
!                                                     ( d_o_no_shock_q3_1 .eq. 1 .and. d_o_shock_q3_2 .eq. 1 ) .and. &                            
!                                                     ( d_o_no_shock_q3_1 .eq. 1 .and. d_o_shock_q3_3 .eq. 1 ) .and. &                            
!                                                     ( d_o_no_shock_q3_1 .eq. 1 .and. d_o_shock_q3_4 .eq. 1 ) .and. &                            
! 
!                                                     ( d_o_no_shock_q3_2 .eq. 1 .and. d_o_shock_q3_1 .eq. 1 ) .and. &                            
!                                                     ( d_o_no_shock_q3_2 .eq. 1 .and. d_o_shock_q3_2 .eq. 1 ) .and. &                            
!                                                     ( d_o_no_shock_q3_2 .eq. 1 .and. d_o_shock_q3_3 .eq. 1 ) .and. &                            
!                                                     ( d_o_no_shock_q3_2 .eq. 1 .and. d_o_shock_q3_4 .eq. 1 ) .and. &                            
! 
!                                                     ( d_o_no_shock_q3_3 .eq. 1 .and. d_o_shock_q3_1 .eq. 1 ) .and. &                            
!                                                     ( d_o_no_shock_q3_3 .eq. 1 .and. d_o_shock_q3_2 .eq. 1 ) .and. &                            
!                                                     ( d_o_no_shock_q3_3 .eq. 1 .and. d_o_shock_q3_3 .eq. 1 ) .and. &                            
!                                                     ( d_o_no_shock_q3_3 .eq. 1 .and. d_o_shock_q3_4 .eq. 1 ) .and. &                            
! 
!                                                     ( d_o_no_shock_q3_4 .eq. 1 .and. d_o_shock_q3_1 .eq. 1 ) .and. &                            
!                                                     ( d_o_no_shock_q3_4 .eq. 1 .and. d_o_shock_q3_2 .eq. 1 ) .and. &                            
!                                                     ( d_o_no_shock_q3_4 .eq. 1 .and. d_o_shock_q3_3 .eq. 1 ) .and. &                            
!                                                     ( d_o_no_shock_q3_4 .eq. 1 .and. d_o_shock_q3_4 .eq. 1 )      &                            
!                                                     ) then
!                                                 
!                                                     omega_no_shock5(jeps3,jk_no_shock_q2_1,inds_no_shock2_1(1))=&
!                                                     omega_no_shock5(jeps3,jk_no_shock_q2_1,inds_no_shock2_1(1))+&
!                                                     vals_no_shock2_1(1)*mass_dummy_q2_1*pi_eps(jeps,jeps3)
!                                                 
!                                                     omega_no_shock5(jeps3,jk_no_shock_q2_1,inds_no_shock2_1(2))=&
!                                                     omega_no_shock5(jeps3,jk_no_shock_q2_1,inds_no_shock2_1(2))+&
!                                                     vals_no_shock2_1(2)*mass_dummy_q2_1*pi_eps(jeps,jeps3)                                                                                            
!                                                 
!                                                     omega_no_shock5(jeps3,jk_no_shock_q2_2,inds_no_shock2_2(1))=&
!                                                     omega_no_shock5(jeps3,jk_no_shock_q2_2,inds_no_shock2_2(1))+&
!                                                     vals_no_shock2_2(1)*mass_dummy_q2_2*pi_eps(jeps,jeps3)
!                                                 
!                                                     omega_no_shock5(jeps3,jk_no_shock_q2_2,inds_no_shock2_2(2))=&
!                                                     omega_no_shock5(jeps3,jk_no_shock_q2_2,inds_no_shock2_2(2))+&
!                                                     vals_no_shock2_2(2)*mass_dummy_q2_2*pi_eps(jeps,jeps3)
!                                                             
! 
!                                                     omega_shock5(jeps3,jk_shock_q2_1,inds_shock2_1(1))=&
!                                                     omega_shock5(jeps3,jk_shock_q2_1,inds_shock2_1(1))+&
!                                                     vals_shock2_1(1)*mass_dummy_q2_3*pi_eps(jeps,jeps3)
!                                                 
!                                                     omega_shock5(jeps3,jk_shock_q2_1,inds_shock2_1(2))=&
!                                                     omega_shock5(jeps3,jk_shock_q2_1,inds_shock2_1(2))+&
!                                                     vals_shock2_1(2)*mass_dummy_q2_3*pi_eps(jeps,jeps3)                                                                                            
!                                                 
!                                                     omega_shock5(jeps3,jk_shock_q2_2,inds_shock2_2(1))=&
!                                                     omega_shock5(jeps3,jk_shock_q2_2,inds_shock2_2(1))+&
!                                                     vals_shock2_2(1)*mass_dummy_q2_4*pi_eps(jeps,jeps3)
!                                                 
!                                                     omega_shock5(jeps3,jk_shock_q2_2,inds_shock2_2(2))=&
!                                                     omega_shock5(jeps3,jk_shock_q2_2,inds_shock2_2(2))+&
!                                                     vals_shock2_2(2)*mass_dummy_q2_4*pi_eps(jeps,jeps3)
!                                                             
!                                                     end if
!                                             
!                                                 end if
...
!         
!         print*,'sum',t
!         write(6,'(300F12.7)')sum(omega_no_shock),sum(omega_shock)
!         
...
!                     (((Z_t(1)*eps)**(1-alpha*nu))*(((k**alpha)*(l**(1-alpha)))**nu)-f_o_good)*omega_ss0(ieps,ik,ia)
! 
...
!                     (((Z_t(tc)*eps)**(1-alpha*nu))*(((k**alpha)*(l**(1-alpha)))**nu)-f_o_good)*omega_ss0(ieps,ik,ia)
! 
...
!                 kp=grid_k(jk)
!                 
!                 d_o_shock=g_i_o_t(t,ieps,ik,ia)
!                 jk_shock=g_i_k_t(t,ieps,ik,ia)
!                 ap_shock=g_i_a_t(t,ieps,ik,ia)                
! 
!                     !next period distribution                                    
!                     if ( d_o .eq. 1 ) then
! 
!                         call basefun (grid_a(1,:),na,ap,vals,inds) 
!                         call basefun (grid_a(t+1,:),na,ap_shock,vals_shock,inds_shock) 
!                         
!                         do jeps=1,neps
!                             
!                             if ( pi_eps(ieps,jeps) .gt. zero ) then                    
...
!                                 d_o_no_shock_q2_2=g_i_o_t(1,jeps,jk,inds(2))
!                                 
!                                 d_o_shock_q2_1=g_i_o_t(t+1,jeps,jk_shock,inds_shock(1))
!                                 d_o_shock_q2_2=g_i_o_t(t+1,jeps,jk_shock,inds_shock(2))
! 
!                                     if ( ( d_o_no_shock_q2_1 .eq. 1 .and. d_o_shock_q2_1 .eq. 1 ) .and. &
!                                     ( d_o_no_shock_q2_1 .eq. 1 .and. d_o_shock_q2_2 .eq. 1 ) .and. &
!                                     ( d_o_no_shock_q2_2 .eq. 1 .and. d_o_shock_q2_1 .eq. 1 ) .and. &
!                                     ( d_o_no_shock_q2_2 .eq. 1 .and. d_o_shock_q2_2 .eq. 1 ) ) then
!                                 
!                                     omega_ss1(jeps,jk,inds(1))=omega_ss1(jeps,jk,inds(1))+vals(1)*pi_eps(ieps,jeps)*omega_ss0(ieps,ik,ia)                                                                            
!                                     omega_ss1(jeps,jk,inds(2))=omega_ss1(jeps,jk,inds(2))+vals(2)*pi_eps(ieps,jeps)*omega_ss0(ieps,ik,ia)                                                     
!                                     
!                                     mass_dummy_q2_1=vals(1)*pi_eps(ieps,jeps)*omega_ss0(ieps,ik,ia)
!                                     mass_dummy_q2_2=vals(2)*pi_eps(ieps,jeps)*omega_ss0(ieps,ik,ia)
!                                     
...
!                                     ap_no_shock_q2_2=g_i_a_t(1,jeps,jk,inds(2))
!     
!                                     jk_shock_q2_1=g_i_k_t(t+1,jeps,jk_shock,inds_shock(1))
!                                     jk_shock_q2_2=g_i_k_t(t+1,jeps,jk_shock,inds_shock(2))
! 
!                                     ap_shock_q2_1=g_i_a_t(t+1,jeps,jk_shock,inds_shock(1))                                                    
!                                     ap_shock_q2_2=g_i_a_t(t+1,jeps,jk_shock,inds_shock(2))                
!                                     
!                                         call basefun (grid_a(1,:),na,ap_no_shock_q2_1,vals_no_shock2_1,inds_no_shock2_1)                                                                                                                     
!                                         call basefun (grid_a(1,:),na,ap_no_shock_q2_2,vals_no_shock2_2,inds_no_shock2_2)                                                                                                                     
! 
!                                         call basefun (grid_a(t+2,:),na,ap_shock_q2_1,vals_shock2_1,inds_shock2_1) 
!                                         call basefun (grid_a(t+2,:),na,ap_shock_q2_2,vals_shock2_2,inds_shock2_2) 
!                                         
!                                         do jeps3=1,neps
!                                             
!                                             if ( pi_eps(jeps,jeps3) .gt. zero ) then                    
...
!                                             d_o_no_shock_q3_4=g_i_o_t(1,jeps3,jk_no_shock_q2_2,inds_no_shock2_2(2))                            
!                                 
!                                             d_o_shock_q3_1=g_i_o_t(t+2,jeps3,jk_shock_q2_1,inds_shock2_1(1))
!                                             d_o_shock_q3_2=g_i_o_t(t+2,jeps3,jk_shock_q2_1,inds_shock2_1(2))                                                                            
!                                             d_o_shock_q3_3=g_i_o_t(t+2,jeps3,jk_shock_q2_2,inds_shock2_2(1))
!                                             d_o_shock_q3_4=g_i_o_t(t+2,jeps3,jk_shock_q2_2,inds_shock2_2(2))                                                                                        
! 
!                                                 if ( &
!                                                 ( d_o_no_shock_q3_1 .eq. 1 .and. d_o_shock_q3_1 .eq. 1 ) .and. &                            
!                                                 ( d_o_no_shock_q3_1 .eq. 1 .and. d_o_shock_q3_2 .eq. 1 ) .and. &                            
...
!                                                 ) then
!                                                 
!                                                 omega_no_shock4(jeps3,jk_no_shock_q2_1,inds_no_shock2_1(1))=&
!                                                 omega_no_shock4(jeps3,jk_no_shock_q2_1,inds_no_shock2_1(1))+&
!                                                 vals_no_shock2_1(1)*mass_dummy_q2_1*pi_eps(jeps,jeps3)
!                                                 
!                                                 omega_no_shock4(jeps3,jk_no_shock_q2_1,inds_no_shock2_1(2))=&
!                                                 omega_no_shock4(jeps3,jk_no_shock_q2_1,inds_no_shock2_1(2))+&
!                                                 vals_no_shock2_1(2)*mass_dummy_q2_1*pi_eps(jeps,jeps3)                                                                                            
!                                                 
!                                                 omega_no_shock4(jeps3,jk_no_shock_q2_2,inds_no_shock2_2(1))=&
!                                                 omega_no_shock4(jeps3,jk_no_shock_q2_2,inds_no_shock2_2(1))+&
!                                                 vals_no_shock2_2(1)*mass_dummy_q2_2*pi_eps(jeps,jeps3)
!                                                 
!                                                 omega_no_shock4(jeps3,jk_no_shock_q2_2,inds_no_shock2_2(2))=&
!                                                 omega_no_shock4(jeps3,jk_no_shock_q2_2,inds_no_shock2_2(2))+&
!                                                 vals_no_shock2_2(2)*mass_dummy_q2_2*pi_eps(jeps,jeps3)
!                                                                  
!                                                 mass_dummy_q3_1=vals_shock2_1(1)*mass_dummy_q2_1*pi_eps(jeps,jeps3)
!                                                 mass_dummy_q3_2=vals_shock2_1(2)*mass_dummy_q2_1*pi_eps(jeps,jeps3)
!                                                 mass_dummy_q3_3=vals_shock2_2(1)*mass_dummy_q2_2*pi_eps(jeps,jeps3)
!                                                 mass_dummy_q3_4=vals_shock2_2(2)*mass_dummy_q2_2*pi_eps(jeps,jeps3)
! 
!                                                 jk_no_shock_q3_1=g_i_k_t(1,jeps3,jk_no_shock_q2_1,inds_no_shock2_1(1))
!                                                 jk_no_shock_q3_2=g_i_k_t(1,jeps3,jk_no_shock_q2_1,inds_no_shock2_1(2))
!                                                 jk_no_shock_q3_3=g_i_k_t(1,jeps3,jk_no_shock_q2_2,inds_no_shock2_2(1))
!                                                 jk_no_shock_q3_4=g_i_k_t(1,jeps3,jk_no_shock_q2_2,inds_no_shock2_2(2))
!                                     
!                                                 ap_no_shock_q3_1=g_i_a_t(1,jeps3,jk_no_shock_q2_1,inds_no_shock2_1(1))
!                                                 ap_no_shock_q3_2=g_i_a_t(1,jeps3,jk_no_shock_q2_1,inds_no_shock2_1(2))
!                                                 ap_no_shock_q3_3=g_i_a_t(1,jeps3,jk_no_shock_q2_2,inds_no_shock2_2(1))
!                                                 ap_no_shock_q3_4=g_i_a_t(1,jeps3,jk_no_shock_q2_2,inds_no_shock2_2(2))
!     
!                                                 jk_shock_q3_1=g_i_k_t(t+2,jeps3,jk_shock_q2_1,inds_shock2_1(1))
!                                                 jk_shock_q3_2=g_i_k_t(t+2,jeps3,jk_shock_q2_1,inds_shock2_1(2))
!                                                 jk_shock_q3_3=g_i_k_t(t+2,jeps3,jk_shock_q2_2,inds_shock2_2(1))
!                                                 jk_shock_q3_4=g_i_k_t(t+2,jeps3,jk_shock_q2_2,inds_shock2_2(2))
! 
!                                                 ap_shock_q3_1=g_i_a_t(t+2,jeps3,jk_shock_q2_1,inds_shock2_1(1))                                                    
!                                                 ap_shock_q3_2=g_i_a_t(t+2,jeps3,jk_shock_q2_1,inds_shock2_1(2))                
!                                                 ap_shock_q3_3=g_i_a_t(t+2,jeps3,jk_shock_q2_2,inds_shock2_2(1))                                                    
!                                                 ap_shock_q3_4=g_i_a_t(t+2,jeps3,jk_shock_q2_2,inds_shock2_2(2))                
! 
!                                                     call basefun (grid_a(1,:),na,ap_no_shock_q3_1,vals_no_shock3_1,inds_no_shock3_1)                                                                                                                     
!                                                     call basefun (grid_a(1,:),na,ap_no_shock_q3_2,vals_no_shock3_2,inds_no_shock3_2)                                                                                                                     
!                                                     call basefun (grid_a(1,:),na,ap_no_shock_q3_3,vals_no_shock3_3,inds_no_shock3_3)                                                                                                                     
!                                                     call basefun (grid_a(1,:),na,ap_no_shock_q3_4,vals_no_shock3_4,inds_no_shock3_4)                                                                                                                     
! 
!                                                     call basefun (grid_a(t+3,:),na,ap_shock_q3_1,vals_shock3_1,inds_shock3_1) 
!                                                     call basefun (grid_a(t+3,:),na,ap_shock_q3_2,vals_shock3_2,inds_shock3_2) 
!                                                     call basefun (grid_a(t+3,:),na,ap_shock_q3_3,vals_shock3_3,inds_shock3_3) 
!                                                     call basefun (grid_a(t+3,:),na,ap_shock_q3_4,vals_shock3_4,inds_shock3_4) 
!                                         
!                                                     do jeps4=1,neps
!                                                     
!                                                         if ( pi_eps(jeps3,jeps4) .gt. zero ) then
! 
!                                                         d_o_no_shock_q4_1=g_i_o_t(1,jeps4,jk_no_shock_q3_1,inds_no_shock3_1(1))                            
!                                                         d_o_no_shock_q4_2=g_i_o_t(1,jeps4,jk_no_shock_q3_1,inds_no_shock3_1(2))                            
!                                                         d_o_no_shock_q4_3=g_i_o_t(1,jeps4,jk_no_shock_q3_2,inds_no_shock3_2(1))                            
!                                                         d_o_no_shock_q4_4=g_i_o_t(1,jeps4,jk_no_shock_q3_2,inds_no_shock3_2(2))                            
!                                                         d_o_no_shock_q4_5=g_i_o_t(1,jeps4,jk_no_shock_q3_3,inds_no_shock3_3(1))                            
!                                                         d_o_no_shock_q4_6=g_i_o_t(1,jeps4,jk_no_shock_q3_3,inds_no_shock3_3(2))                            
!                                                         d_o_no_shock_q4_7=g_i_o_t(1,jeps4,jk_no_shock_q3_4,inds_no_shock3_4(1))                            
!                                                         d_o_no_shock_q4_8=g_i_o_t(1,jeps4,jk_no_shock_q3_4,inds_no_shock3_4(2))                                                            
!                                 
!                                                         d_o_shock_q4_1=g_i_o_t(t+3,jeps4,jk_shock_q3_1,inds_shock3_1(1))
!                                                         d_o_shock_q4_2=g_i_o_t(t+3,jeps4,jk_shock_q3_1,inds_shock3_1(2))                                                                            
!                                                         d_o_shock_q4_3=g_i_o_t(t+3,jeps4,jk_shock_q3_2,inds_shock3_2(1))
!                                                         d_o_shock_q4_4=g_i_o_t(t+3,jeps4,jk_shock_q3_2,inds_shock3_2(2))                                                                                        
!                                                         d_o_shock_q4_5=g_i_o_t(t+3,jeps4,jk_shock_q3_3,inds_shock3_3(1))
!                                                         d_o_shock_q4_6=g_i_o_t(t+3,jeps4,jk_shock_q3_3,inds_shock3_3(2))                                                                            
!                                                         d_o_shock_q4_7=g_i_o_t(t+3,jeps4,jk_shock_q3_4,inds_shock3_4(1))
!                                                         d_o_shock_q4_8=g_i_o_t(t+3,jeps4,jk_shock_q3_4,inds_shock3_4(2))                                                                                        
!                                             
!                                                             if ( &
!                                                             d_o_no_shock_q4_1 .eq. 1 .and. d_o_shock_q4_1 .eq. 1 .and. &                            
!                                                             d_o_no_shock_q4_2 .eq. 1 .and. d_o_shock_q4_2 .eq. 1 .and. &                            
!                                                             d_o_no_shock_q4_3 .eq. 1 .and. d_o_shock_q4_3 .eq. 1 .and. &                            
!                                                             d_o_no_shock_q4_4 .eq. 1 .and. d_o_shock_q4_4 .eq. 1 .and. &                            
!                                                             d_o_no_shock_q4_5 .eq. 1 .and. d_o_shock_q4_5 .eq. 1 .and. &                            
!                                                             d_o_no_shock_q4_6 .eq. 1 .and. d_o_shock_q4_6 .eq. 1 .and. &                            
!                                                             d_o_no_shock_q4_7 .eq. 1 .and. d_o_shock_q4_7 .eq. 1 .and. &                            
!                                                             d_o_no_shock_q4_8 .eq. 1 .and. d_o_shock_q4_8 .eq. 1       &                            
!                                                             ) then
!                                                             
!                                                             omega_no_shock5(jeps4,jk_no_shock_q3_1,inds_no_shock3_1(1))=&
!                                                             omega_no_shock5(jeps4,jk_no_shock_q3_1,inds_no_shock3_1(1))+&
!                                                             vals_no_shock3_1(1)*mass_dummy_q3_1*pi_eps(jeps3,jeps4)
!                                                 
!                                                             omega_no_shock5(jeps4,jk_no_shock_q3_1,inds_no_shock3_1(2))=&
!                                                             omega_no_shock5(jeps4,jk_no_shock_q3_1,inds_no_shock3_1(2))+&
!                                                             vals_no_shock3_1(2)*mass_dummy_q3_1*pi_eps(jeps3,jeps4)
!                                                                                                                                                                                                 
!                                                             omega_no_shock5(jeps4,jk_no_shock_q3_2,inds_no_shock3_2(1))=&
!                                                             omega_no_shock5(jeps4,jk_no_shock_q3_2,inds_no_shock3_2(1))+&
!                                                             vals_no_shock3_2(1)*mass_dummy_q3_2*pi_eps(jeps3,jeps4)
!                                                 
!                                                             omega_no_shock5(jeps4,jk_no_shock_q3_2,inds_no_shock3_2(2))=&
!                                                             omega_no_shock5(jeps4,jk_no_shock_q3_2,inds_no_shock3_2(2))+&
!                                                             vals_no_shock3_2(2)*mass_dummy_q3_2*pi_eps(jeps3,jeps4)
!                                                 
!                                                             omega_no_shock5(jeps4,jk_no_shock_q3_3,inds_no_shock3_3(1))=&
!                                                             omega_no_shock5(jeps4,jk_no_shock_q3_3,inds_no_shock3_3(1))+&
!                                                             vals_no_shock3_3(1)*mass_dummy_q3_3*pi_eps(jeps3,jeps4)
!                                                 
!                                                             omega_no_shock5(jeps4,jk_no_shock_q3_3,inds_no_shock3_3(2))=&
!                                                             omega_no_shock5(jeps4,jk_no_shock_q3_3,inds_no_shock3_3(2))+&
!                                                             vals_no_shock3_3(2)*mass_dummy_q3_3*pi_eps(jeps3,jeps4)
!                                                                                                                                                                                                 
!                                                             omega_no_shock5(jeps4,jk_no_shock_q3_4,inds_no_shock3_4(1))=&
!                                                             omega_no_shock5(jeps4,jk_no_shock_q3_4,inds_no_shock3_4(1))+&
!                                                             vals_no_shock3_4(1)*mass_dummy_q3_4*pi_eps(jeps3,jeps4)
!                                                 
!                                                             omega_no_shock5(jeps4,jk_no_shock_q3_4,inds_no_shock3_4(2))=&
!                                                             omega_no_shock5(jeps4,jk_no_shock_q3_4,inds_no_shock3_4(2))+&
!                                                             vals_no_shock3_4(2)*mass_dummy_q3_4*pi_eps(jeps3,jeps4)                                                                                                
! !                                                             
!                                                             end if
!                                                             
!                                                         end if
...
!                 kp=grid_k(jk)
!                 
!                 d_o_no_shock=g_i_o_t(1,ieps,ik,ia)
!                 jk_no_shock=g_i_k_t(1,ieps,ik,ia)
!                 ap_no_shock=g_i_a_t(1,ieps,ik,ia)                                
!                                                                                 
!                     !next period distribution                                    
!                     if ( d_o .eq. 1 ) then
! 
!                         call basefun (grid_a(t+1,:),na,ap,vals,inds) 
!                         call basefun (grid_a(1,:),na,ap_no_shock,vals_no_shock,inds_no_shock) 
!                         
!                         do jeps=1,neps
!                             
!                             if ( pi_eps(ieps,jeps) .gt. zero ) then                    
...
!                                 if ( t .eq. 2 ) then
!                                 
!                                 d_o_shock_q2_1=g_i_o_t(t+1,jeps,jk,inds(1))                            
!                                 d_o_shock_q2_2=g_i_o_t(t+1,jeps,jk,inds(2))
!                                 
!                                 d_o_no_shock_q2_1=g_i_o_t(1,jeps,jk_no_shock,inds_no_shock(1))
!                                 d_o_no_shock_q2_2=g_i_o_t(1,jeps,jk_no_shock,inds_no_shock(2))
! 
!                                     if ( ( d_o_no_shock_q2_1 .eq. 1 .and. d_o_shock_q2_1 .eq. 1 ) .and. &
!                                     ( d_o_no_shock_q2_1 .eq. 1 .and. d_o_shock_q2_2 .eq. 1 ) .and. &
!                                     ( d_o_no_shock_q2_2 .eq. 1 .and. d_o_shock_q2_1 .eq. 1 ) .and. &
...
!                                     mass_dummy_q2_2=vals(2)*pi_eps(ieps,jeps)*omega_ss0(ieps,ik,ia)
!                                     
!                                     jk_shock_q2_1=g_i_k_t(t+1,jeps,jk,inds(1))
!                                     jk_shock_q2_2=g_i_k_t(t+1,jeps,jk,inds(2))
!                                     
!                                     ap_shock_q2_1=g_i_a_t(t+1,jeps,jk,inds(1))
!                                     ap_shock_q2_2=g_i_a_t(t+1,jeps,jk,inds(2))
!     
!                                     jk_no_shock_q2_1=g_i_k_t(1,jeps,jk_no_shock,inds_no_shock(1))
!                                     jk_no_shock_q2_2=g_i_k_t(1,jeps,jk_no_shock,inds_no_shock(2))
!                                     
!                                     ap_no_shock_q2_1=g_i_a_t(1,jeps,jk_no_shock,inds_no_shock(1))                    
!                                     ap_no_shock_q2_2=g_i_a_t(1,jeps,jk_no_shock,inds_no_shock(2))                
!                                     
!                                         call basefun (grid_a(t+2,:),na,ap_shock_q2_1,vals_shock2_1,inds_shock2_1) 
!                                         call basefun (grid_a(t+2,:),na,ap_shock_q2_2,vals_shock2_2,inds_shock2_2) 
! 
...
!                                                 ) then
!                                                 
!                                                 omega_shock4(jeps3,jk_shock_q2_1,inds_shock2_1(1))=&
!                                                 omega_shock4(jeps3,jk_shock_q2_1,inds_shock2_1(1))+&
!                                                 vals_shock2_1(1)*mass_dummy_q2_1*pi_eps(jeps,jeps3)
!                                                 
!                                                 omega_shock4(jeps3,jk_shock_q2_1,inds_shock2_1(2))=&
!                                                 omega_shock4(jeps3,jk_shock_q2_1,inds_shock2_1(2))+&
!                                                 vals_shock2_1(2)*mass_dummy_q2_1*pi_eps(jeps,jeps3)
!                                                                                                                                                                                                 
!                                                 omega_shock4(jeps3,jk_shock_q2_2,inds_shock2_2(1))=&
!                                                 omega_shock4(jeps3,jk_shock_q2_2,inds_shock2_2(1))+&
!                                                 vals_shock2_2(1)*mass_dummy_q2_2*pi_eps(jeps,jeps3)
!                                                 
!                                                 omega_shock4(jeps3,jk_shock_q2_2,inds_shock2_2(2))=&
!                                                 omega_shock4(jeps3,jk_shock_q2_2,inds_shock2_2(2))+&
!                                                 vals_shock2_2(2)*mass_dummy_q2_2*pi_eps(jeps,jeps3)
!                                                                                                 
!                                                 mass_dummy_q3_1=vals_shock2_1(1)*mass_dummy_q2_1*pi_eps(jeps,jeps3)
!                                                 mass_dummy_q3_2=vals_shock2_1(2)*mass_dummy_q2_1*pi_eps(jeps,jeps3)
!                                                 mass_dummy_q3_3=vals_shock2_2(1)*mass_dummy_q2_2*pi_eps(jeps,jeps3)
...
!                                                             ) then                                                            
!                                                             
!                                                             omega_shock5(jeps4,jk_shock_q3_1,inds_shock3_1(1))=&
!                                                             omega_shock5(jeps4,jk_shock_q3_1,inds_shock3_1(1))+&
!                                                             vals_shock3_1(1)*mass_dummy_q3_1*pi_eps(jeps3,jeps4)
!                                                 
!                                                             omega_shock5(jeps4,jk_shock_q3_1,inds_shock3_1(2))=&
!                                                             omega_shock5(jeps4,jk_shock_q3_1,inds_shock3_1(2))+&
!                                                             vals_shock3_1(2)*mass_dummy_q3_1*pi_eps(jeps3,jeps4)
!                                                                                                                                                                                                 
!                                                             omega_shock5(jeps4,jk_shock_q3_2,inds_shock3_2(1))=&
!                                                             omega_shock5(jeps4,jk_shock_q3_2,inds_shock3_2(1))+&
!                                                             vals_shock3_2(1)*mass_dummy_q3_2*pi_eps(jeps3,jeps4)
!                                                 
!                                                             omega_shock5(jeps4,jk_shock_q3_2,inds_shock3_2(2))=&
!                                                             omega_shock5(jeps4,jk_shock_q3_2,inds_shock3_2(2))+&
!                                                             vals_shock3_2(2)*mass_dummy_q3_2*pi_eps(jeps3,jeps4)
!                                                 
!                                                             omega_shock5(jeps4,jk_shock_q3_3,inds_shock3_3(1))=&
!                                                             omega_shock5(jeps4,jk_shock_q3_3,inds_shock3_3(1))+&
!                                                             vals_shock3_3(1)*mass_dummy_q3_3*pi_eps(jeps3,jeps4)
!                                                 
!                                                             omega_shock5(jeps4,jk_shock_q3_3,inds_shock3_3(2))=&
!                                                             omega_shock5(jeps4,jk_shock_q3_3,inds_shock3_3(2))+&
!                                                             vals_shock3_3(2)*mass_dummy_q3_3*pi_eps(jeps3,jeps4)
!                                                                                                                                                                                                 
!                                                             omega_shock5(jeps4,jk_shock_q3_4,inds_shock3_4(1))=&
!                                                             omega_shock5(jeps4,jk_shock_q3_4,inds_shock3_4(1))+&
!                                                             vals_shock3_4(1)*mass_dummy_q3_4*pi_eps(jeps3,jeps4)
!                                                 
!                                                             omega_shock5(jeps4,jk_shock_q3_4,inds_shock3_4(2))=&
!                                                             omega_shock5(jeps4,jk_shock_q3_4,inds_shock3_4(2))+&
!                                                             vals_shock3_4(2)*mass_dummy_q3_4*pi_eps(jeps3,jeps4)                                                                                                
!                                                 
!                                                             end if
!                                                 
!                                                         end if
...
!     deallocate (omega_no_shock, omega_shock, omega_no_shock4, omega_shock4, omega_no_shock5, omega_shock5)
...
!         close(1)
    ...
    deallocate (g_i_o_t, g_i_k_t, g_i_a_t, g_e_o_t, g_un_k_t, g_un_o_t, g_i_a_integer_t)
