...
integer, parameter :: ex_entry=1, default_economy=1, compute_job_flows=0
double precision, parameter :: one=1, zero=0
double precision, parameter :: beta=.99
double precision, parameter :: nu=0.83625, delta_k=1-(1-.06)**.25, delta_f=0
double precision, parameter :: phi=.5

double precision :: ex_mu

double precision :: chi, lambda
double precision, parameter :: lambda_c=0.25
...
double precision, parameter :: kmin=1e-13, kmax=400, amax=500, amin=-99
...
double precision :: avg_spread, debtors
...
double precision, dimension(t1) :: ngdp_t, ninv_t, avg_spread_t, debtors_t
...
double precision, dimension(max_age) :: avg_log_emp_by_age, std_dev_log_emp_by_age, dummy_by_age, investment_by_age, spread_by_age, debtors_by_age
