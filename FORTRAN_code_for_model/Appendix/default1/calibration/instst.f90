...
g_binding_collateral_initial=g_binding_collateral
g_i_a_integer_initial=g_i_a_integer
    ...
    omega_ss1=zero
        ...
        do ia=1,na
            ...
            div_by_age(iter_dist)=div_by_age(iter_dist)+profit*omega_ss0(ieps,ik,ia)
                ...
                if ( ap .lt. zero ) then
                spread_by_age(iter_dist)=spread_by_age(iter_dist)+(one/q-1-r)*omega_ss0(ieps,ik,ia)
                debtors_by_age(iter_dist)=debtors_by_age(iter_dist)+omega_ss0(ieps,ik,ia)
                end if
...
!                 l=l+f_e                
    ...
    print*,'spread',avg_spread
        ...
        write(1,*)'avg_log_emp std_dev_log_emp avg_spread'
            ...
            avg_log_emp_by_age(iter_dist),std_dev_log_emp_by_age(iter_dist),spread_by_age(iter_dist)/debtors_by_age(iter_dist)
            end do
        close(1)
