...
!parameters
integer, parameter :: usespline=0, cap_adj=1, GHH=1, Habit=1        !0=no adjustment cost, 1=costly reversibility, 2=non-convex
...
double precision, parameter :: kmin=1e-13, kmax=400, amax=425, amin=-99
