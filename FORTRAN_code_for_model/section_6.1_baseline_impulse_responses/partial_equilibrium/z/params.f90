...
integer(kind=1), dimension(neps,nk,na) :: g_i_o
...
double precision, dimension(max_age) :: avg_log_emp_by_age, std_dev_log_emp_by_age, dummy_by_age
...
double precision :: cut_off_model, cut_off_data, shock
