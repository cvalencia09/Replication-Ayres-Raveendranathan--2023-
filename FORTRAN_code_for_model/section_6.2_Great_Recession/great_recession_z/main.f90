...
z_t(2:41)=z_t_data(2:41)
    ...
    theta_t=theta_t(1)
        ...
        print*,'shock firm_debt_gdp_12th_quarter'
        write(6,'(300F12.4)')shock,1.633801328,-firm_debt_t(12)/ngdp_t(12)

        print*,'rho_shock firm_debt_gdp_40th_quarter'
        write(6,'(300F12.4)')rho_shock,1.660430134,-firm_debt_t(40)/ngdp_t(40)
        ...
        shock=shock*(1.633801328/(-firm_debt_t(12)/ngdp_t(12)))**.7
        rho_shock=rho_shock*((-firm_debt_t(40)/ngdp_t(40))/1.660430134)**.4
